...
INSERT INTO `configuracion_app` VALUES (1,'app_nombre','SerTecApp','Nombre de la aplicaciâ”œâ”‚n','texto',NULL,'2025-11-15 16:30:43'),(2,'app_logo_url',NULL,'URL del logo personalizado','imagen',NULL,'2025-11-15 16:30:43'),(3,'app_color_primario','#3B82F6','Color primario de la aplicaciâ”œâ”‚n','texto',NULL,'2025-11-15 16:30:43'),(4,'empresa_nombre',NULL,'Nombre de la empresa','texto',NULL,'2025-11-15 16:30:43'),(5,'empresa_telefono',NULL,'Telâ”œÂ®fono de contacto','texto',NULL,'2025-11-15 16:30:43'),(6,'empresa_email',NULL,'Email de contacto','texto',NULL,'2025-11-15 16:30:43'),(7,'empresa_direccion',NULL,'Direcciâ”œâ”‚n fâ”œÂ¡sica','texto',NULL,'2025-11-15 16:30:43');
...
CREATE TABLE `facturas` (
  ...
  `orden_trabajo_id` int DEFAULT NULL COMMENT 'Si la factura es de una orden especâ”œÂ¡fica',
...
CREATE TABLE `repuestos` (
  ...
  `ubicacion` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ubicaciâ”œâ”‚n fâ”œÂ¡sica en depâ”œâ”‚sito',
  `activo` tinyint(1) DEFAULT '1',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `taller_equipos` (
  ...
  `origen` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'De dâ”œâ”‚nde viene el equipo',
  `equipo_marca` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `equipo_modelo` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `equipo_serie` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `visitas_abono` (
  ...
  `anio` int NOT NULL,
  `numero_visita` tinyint NOT NULL COMMENT 'Quâ”œÂ® visita del mes es (1, 2 o 3)',
