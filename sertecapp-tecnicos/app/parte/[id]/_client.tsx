      ...
      if (effectiveOnline) {
        try {
          ...
          if (response.ok) {
            ...
            saveParteLocal({ orden_id: parseInt(params.id as string), tecnico_id: user.id || 1, diagnostico, trabajo_realizado: trabajoRealizado, repuestos_usados: repuestos, firma_base64: firma });
